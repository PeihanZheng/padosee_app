...
class ApartmentSecondary extends StatefulWidget {
  const ApartmentSecondary({Key? key}) : super(key: key);

  @override
  State<ApartmentSecondary> createState() => _ApartmentSecondaryState();
}

class _ApartmentSecondaryState extends State<ApartmentSecondary> {
